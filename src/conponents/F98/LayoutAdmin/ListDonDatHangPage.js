...
const DonHangComponent = () => {
                                ...
                                <tr key={dh.idHD} >
                                    <td style={{ width: '400px' }} onClick={() => handleXemChiTiet(dh.idHD)}>
                                        <div>
                                            ...
                                            <strong>Tên: {dh.tenNguoiNhan}</strong><br />
                                            SĐT: {dh.sdt}<br />
                                            Địa chỉ: {dh.diaChi}
                                            <br />
                                            Ghi chú: {dh.ghiChu}
                                    ...
                                    <td>
                                        <Dropdown>
                                            ...
                                            <Dropdown.Menu>
                                                ...
                                                {activeTrangThai !== "Đã nhận" && activeTrangThai !== "Đã hủy" && activeTrangThai !== "Hoàn trả" ? (
                                                    <Dropdown.Item>
                                                        <button
    ...
    return (
        <div className="container mt-4" style={{ width: 1300, backgroundColor: 'white', borderRadius: '15px' }}>
