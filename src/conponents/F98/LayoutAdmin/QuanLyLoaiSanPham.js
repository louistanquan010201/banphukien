...
import Quanlyloaisanpham from './QuanLyLoaiSanPhamPage';
import Footer from './Footer';

const QuanLLoaisanpham = () => (
  <div>
    <meta charSet="utf-8" />
    ...
    <div id="app">
      <Sidebar />
      <div id="main-content" style={{width:'1400px',marginLeft:'15px'}}>
        <Header />
        <Quanlyloaisanpham />
        <Footer />
      </div>
...
export default QuanLLoaisanpham;
