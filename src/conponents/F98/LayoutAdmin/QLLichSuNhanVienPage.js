...
const QuanlyLichsunv = () => {
    ...
    const fetchLoailichsu = async () => {
        ...
        try {
            const response = await axios.get(`https://naton69587-001-site1.mtempurl.com/api/LichSu/PhanTrangnv`, {
    ...
    return (
        <div className="container" style={{ width: 1300, marginLeft: 250, backgroundColor: 'white', borderRadius: '15px' }}>
            <h2 className="text-center mb-4">Lịch sử thao tác nhân viên</h2>
            <div class="row">
                <div class="col-sm-12">
                    <div>
                        <input
